    ...
    <nav class="top-navbar">
        ...
        <a class="navbar-brand" href="#">
            <img class="img-fluid" src="<?= base_url() . 'assets/img/logo_noire.png' ?>" alt="Logo Softio" style="height:50px; width:100%; z-index: 1000; background:inear-gradient(180deg, #2c3e50 0%, #34495e 100%);">
        </a>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-menu">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?= base_url('admin/hero') ?>" class="menu-item active"><span><i class="fas fa-image"></i></span> Hero</a></li>
            ...
            <div class="modal-content" style="border-radius:18px;overflow:hidden;">
                <div class="modal-header" style="background:#f5f5f5; border-bottom:1px solid #eee; align-items:center;">
                    <h5 class="modal-title d-flex align-items-center gap-2" id="registerModalLabel" style="font-weight:600;">
                        <i class="fa fa-edit text-warning me-2"></i> Modifier un hero
                    </h5>
                ...
                <div class="modal-body" style="padding:2rem 2.5rem 1.5rem 2.5rem;">
                    ...
                    <form id="formEdit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="idHero" id="edit-id">
                        <div class="mb-3">

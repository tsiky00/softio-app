...
<nav class="sidebar" id="sidebar">
    <div class="sidebar-menu">
        ...
        <a href="<?= base_url('admin/expertise') ?>"  class="menu-item active"><span><i class="fas fa-cogs"></i></span> Expértises</a>
...
<main class="main-content" id="mainContent">
    ...
    <div class="onglet">
        <a href="#" id="vente_" class="onglet_btn active"> Expertise</a>
    </div>

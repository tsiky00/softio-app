...
<main class="main-content" id="mainContent">
    ...
    <div class="onglet">
        <a href="#" id="vente_" class="onglet_btn active"> Contact</a>
    </div>

    <div class="zone-form">
        <form id="formSend" method="post">
            <div class="mb-3">
                <label for="numero" class="form-label">Contact</label>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <div class="invalid-feedback" id="error-adresse"></div>
                </div>
            </div>
        ...
        <div class="modal-content" style="border-radius:18px;overflow:hidden;">
            <div class="modal-header" style="background:#f5f5f5; border-bottom:1px solid #eee; align-items:center;">
                <h5 class="modal-title d-flex align-items-center gap-2" id="registerModalLabel" style="font-weight:600;">
                    <i class="fa fa-edit text-warning me-2"></i> Modifier un contact
                </h5>
            ...
            <div class="modal-body" style="padding:2rem 2.5rem 1.5rem 2.5rem;">
                ...
                <form id="formEdit" method="post">
                    <input type="hidden" name="idContact" id="edit-id">
                    <div class="mb-3">
                        <label for="edit-numero" class="form-label">Titre</label>
                        <input type="number" class="form-control" name="numero" id="edit-numero" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit-adresse" class="form-label">Titre</label>
                        <input type="text" class="form-control" name="adresse" id="edit-adresse" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit-email" class="form-label">Titre</label>

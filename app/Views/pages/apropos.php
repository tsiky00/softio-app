...
<nav class="sidebar" id="sidebar">
    <div class="sidebar-menu">
        ...
        <a href="<?= base_url('admin/apropos') ?>" class="menu-item active"><span><i class="fas fa-info-circle"></i></span> À propos</a>
...
<main class="main-content" id="mainContent">
    ...
    <div class="onglet">
        <a href="#" id="vente_" class="onglet_btn active"> Apropos</a>
    </div>
